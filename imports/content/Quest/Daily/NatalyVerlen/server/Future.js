export default {
  ...
  answers: {
    ...
    science: {
      ...
      win: 'Это было гениально, Командующий! Мы определили точку, которая находится где-то далеко за пределами нашей галактики. Предположительно, она находится в центре чёрной дыры. Это открытие сильно подтолкнёт развитие науки на нашей колонии, Консул.',
