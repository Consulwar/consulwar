export default {
  ...
  text: '<p>Как вы уже знаете, после 20-го уровня моментально ускорить строительство бесплатно уже не получится. Поэтому, чтобы сократить время строительства, нужно развить такое исследование, как Особые Сплавы. Как минимум до 25-го уровня. Для этого потребуется Шахта Металла 25-го уровня, а для неё – Кристаллизация 25-го уровня. Подсказок больше не будет! Такой серьёзный правитель, как вы, справится и без них. </p>',
  options: {
    accept: {
